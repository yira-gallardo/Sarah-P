    ...
    <>
      ...
      <main className={styles.main}>
        ...
        {menuActive && (
          ...
          <div className={styles.menuMobile}>
            ...
            <div
              ...
              onClick={() => goToSection("musicDesktop")}
            >
              Música
            </div>
            ...
            >
              <div className={styles.content}>
                ...
                <div
                  ...
                  onClick={() => goToSection("bioDesktop")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="35"
        ...
        <nav className={styles.navDesktop} id="menu">
          <div className="container">
            ...
            <div
              href="/"
              className={styles.link}
              onClick={() => goToSection("videosDesktop")}
            >
              Videos
            </div>
            <div
              href="/"
              className={styles.link}
              onClick={() => goToSection("contactoDesktop")}
            >
              Contacto
            </div>
          </div>
        </nav>
        <section className={`${styles.bio} ${styles.bioMobile}`} id="bio">
          <div className="container">
            <div className={styles.bioBox}>
              ...
              >
                ...
                <div className={styles.text}>
                  ...
                  <p>
                    Su segundo sencillo, &apos;TE CREÍA&apos; es una composición
                    de su propia inspiración que refleja una relación rota con
                    una persona que te engaña por aparentar algo que no es. Este
                    corte musical está a cargo de la producción de Alex Hoyer y
                    estará disponible en todas las plataformas digitales a
                    partir del verano 2022.
                  </p>
        ...
        <Parallax bgImage={image2} strength={200}>
          <section
            className={`${styles.bio} ${styles.bioDesktop}`}
            id="bioDesktop"
          >
            <div className="container">
              <div className={styles.bioBox}>
        ...
        <section className={styles.music} id="musicDesktop">
          <div className="container">
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
        ...
        <section
          className={`${styles.videos} ${styles.videosMobile}`}
          id="videos"
        >
          <div className="container">
            <motion.div
        ...
        <Parallax bgImage={image5} strength={200}>
          <section
            className={`${styles.videos} ${styles.videosDesktop}`}
            id="videosDesktop"
          >
            <div className="container">
              <motion.div
        ...
        <footer className={`${styles.contacto} ${styles.contactoMobile}`}>
          <div className={styles.content}>
            <div className="container">
        ...
        <Parallax bgImage={image4} strength={200}>
          <footer className={`${styles.contacto} ${styles.contactoDesktop}`}>
            <div className={styles.content}>
              <div className="container">
                <div className={styles.heading} id="contactoDesktop">
                  <h2>Contacto</h2>
                </div>
                <div className={styles.contactoBox}>
                  <div className={styles.left}>
