      ...
      <main className={styles.main}>
              ...
              <div className={styles.left}>
                ...
                <div className={styles.heading}>
                  <div className={styles.title}>
                    <h3>
                      Dolore ad sunt minim est quis sit fugiat tempor ea.Ipsum
                      aliqua ut ullamco
                    </h3>
                  </div>
              ...
              <div className={styles.contactoBox}>
                ...
                <div className={styles.right}>
                  ...
                  <div className={styles.link}>
                    <a href="mailto:asdasd@gmail.com">asdasd@gmail.com</a>
                  </div>
                  <div className={styles.link}>
                    <a href="tel:asdasd@gmail.com">5512341234</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <footer className={styles.footer}>
          <div className="container">
            ...
            <div className={styles.content}>
              <h1>Sarah Portaluppi</h1>
              <h2>Sarah Portaluppi 2023® Todos los derechos reservados</h2>
            </div>
          </div>
        </footer>
      </main>
